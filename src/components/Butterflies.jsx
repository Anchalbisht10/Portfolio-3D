...
const butterfliesData = [
  ...
  { x: 15, y: 40, size: 22, color: "#EBBCB0", delay: 1.5, duration: 10 },
  ...
  { x: 45, y: 60, size: 20, color: "#F2CEC6", delay: 2.2, duration: 11 },
  { x: 72, y: 45, size: 22, color: "#EBBCB0", delay: 1.2, duration: 8  },
  { x: 18, y: 55, size: 18, color: "#F2CEC6", delay: 3.5, duration: 10 },
  { x: 55, y: 30, size: 22, color: "#EBBCB0", delay: 0.7, duration: 12 },
  { x: 92, y: 75, size: 20, color: "#F2CEC6", delay: 1.6, duration: 9  },
  { x: 3,  y: 50, size: 24, color: "#EBBCB0", delay: 2.8, duration: 7  },
  { x: 65, y: 15, size: 22, color: "#F2CEC6", delay: 0.4, duration: 11 },
  { x: 40, y: 90, size: 18, color: "#EBBCB0", delay: 3.2, duration: 10 },
  { x: 78, y: 60, size: 22, color: "#F2CEC6", delay: 1.1, duration: 8  },
  { x: 32, y: 8,  size: 26, color: "#EBBCB0", delay: 0.6, duration: 9  },
  { x: 58, y: 48, size: 20, color: "#F2CEC6", delay: 2.9, duration: 8  },
  { x: 12, y: 22, size: 24, color: "#EBBCB0", delay: 1.4, duration: 11 },
  { x: 83, y: 82, size: 22, color: "#F2CEC6", delay: 0.9, duration: 10 },
  { x: 47, y: 35, size: 18, color: "#EBBCB0", delay: 3.8, duration: 9  },
  { x: 22, y: 88, size: 26, color: "#F2CEC6", delay: 1.7, duration: 7  },
  { x: 95, y: 30, size: 20, color: "#EBBCB0", delay: 2.3, duration: 12 },
  { x: 38, y: 62, size: 22, color: "#F2CEC6", delay: 0.2, duration: 10 },
  { x: 68, y: 28, size: 24, color: "#EBBCB0", delay: 4.2, duration: 8  },
  { x: 2,  y: 35, size: 18, color: "#F2CEC6", delay: 1.3, duration: 11 },
];
